...
const Boards = () => {
  ...
  const [sortOption, setSortOption] = useState("createdAt_desc"); // 기본 정렬 설정
  ...
  }, [keyword, searchOption, sortOption, category]); // sortOption 추가
  ...
  const handleSortOptionChange = (event) => {
    ...
    setPage(0);
    fetchData(0); // 정렬 옵션 변경 시 데이터 새로 로드
  };
    ...
    <Box m="20px">
      ...
      >
        <Box display="flex" alignItems="center" flexGrow={1}>
          ...
          <Select
            value={sortOption}
            onChange={handleSortOptionChange} // 정렬 옵션 변경 처리
            sx={{
              color: colors.gray[100],
              backgroundColor: colors.primary[500],
              mr: 2,
          ...
          >
            ...
            <MenuItem value="views_desc">조회수순</MenuItem>
          </Select>
